...
1. Review the [existing issues](https://github.com/playfulsparkle/oc4_product_category_filter/issues) to avoid duplicates.
...
- [GitHub Issues](https://github.com/playfulsparkle/oc4_product_category_filter/issues)
